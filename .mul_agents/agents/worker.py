...
#         content='''
#         You are a researcher who does research on game dev projects. 
...
#     find the latest innovations and trends on game dev projects.
#                           ''',
...
def push_task(text, proj_content = "") -> list:
    ...
    json_array_str = answer[start_index:end_index]
